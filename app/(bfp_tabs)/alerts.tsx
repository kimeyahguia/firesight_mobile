...
const styles = StyleSheet.create({
  ...
  headerRow: { paddingHorizontal: 20, paddingTop: 50, paddingBottom: 4 },
  headerTitle: { ...TYPOGRAPHY.screenTitle, color: COLORS.deepIndigo, letterSpacing: -0.3 },
  ...
  // Touch-Friendly: explicit minHeight matching the 44-48px standard used
  // across the app instead of relying on paddingVertical alone
  segmentBtn: {
    flex: 1,
    flexDirection: 'row',
    alignItems: 'center',
  ...
  // Touch-Friendly: fixed height 40 (was padding-only, inconsistent tap area)
  yearChip: {
  ...
  // Shared card — matching the incidents screen's card shadow/elevation
  card: {
    marginHorizontal: 16,
    marginTop: 14,
    padding: 16,
  ...
  riskBadgeSm: { paddingHorizontal: 8, paddingVertical: 4 },
  ...
  // Touch-Friendly: fixed height 40, same standard as yearChip
  filterChip: {
    paddingHorizontal: 16,
    height: 40,
    justifyContent: 'center',
  ...
  notifDescription: { color: COLORS.slateText, fontSize: FONT_SIZES.caption, marginTop: 4, lineHeight: 18 },
  statusBadge: {
